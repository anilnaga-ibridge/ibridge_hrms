...
class SuperAdminCommon
{
    public static function createWebsiteSetting($langKey)
    {
        ...
        $websiteSetting->credentials = [
            ...
            'header_logo_url' => '/images/dark.png',
            'header_sidebar_logo' => 'dark.png',
            'header_sidebar_logo_url' => '/images/dark.png',
            'home_text' => 'Home',
            ...
            'header_background_image_url' => '/images/website_fnqvedbvmtszeclh3asu.png',
            ...
            'contact_form_background_image_url' => '/images/website_tuwr3wrbo82subzrq54u.jpeg',
            ...
            'register_background_url' => '/images/website_x5a4sofrquzz347p9mlq.svg',
            ...
            'most_popular_image_url' => '/images/website_bk6blpq7x3tehqtehvpk.png',
            ...
            'faq_background_image_url' => '/images/website_b1043pp5aa7w02x47yn2.svg',
            ...
            'footer_logo_url' => '/images/dark.png',
        ...
        $websiteSetting->credentials = [
            0 => [
                ...
                'logo_url' => '/images/website_cu59zyps8n5aoemo9gnz.png',
            ],
            1 => [
                'id' => '2hexby4e6ap',
                'name' => 'Client 2',
                'logo' => 'website_e5j160j95fpentqkt6ft.png',
                'logo_url' => '/images/website_e5j160j95fpentqkt6ft.png',
            ],
            2 => [
                'id' => '3hexby4e6ap',
                'name' => 'Client 3',
                'logo' => 'website_ibk9dmvu0x2fdfbo7ubz.png',
                'logo_url' => '/images/website_ibk9dmvu0x2fdfbo7ubz.png',
            ],
            3 => [
                'id' => '4hexby4e6ap',
                'name' => 'Client 4',
                'logo' => 'website_avj3oskupxs7uufcpfdd.png',
                'logo_url' => '/images/website_avj3oskupxs7uufcpfdd.png',
            ],
            4 => [
                'id' => '5hexby4e6ap',
                'name' => 'Client 5',
                'logo' => 'website_qxykessgtfj8d4yukwzj.png',
                'logo_url' => '/images/website_qxykessgtfj8d4yukwzj.png',
            ],
        ];
        $websiteSetting->save();
        ...
        $websiteSetting->credentials = [
            0 => [
                ...
                'image_url' => '/images/website_tdsppriozkto3zfipazg.png',
            ],
            1 => [
                'id' => '22hexby4e6ap',
                'name' => 'Assets',
                ...
                'image_url' => '/images/website_suno5u13gqhgmoxnqfjt.png',
            ],
            2 => [
                'id' => '23hexby4e6ap',
                'name' => 'Locations',
                ...
                'image_url' => '/images/website_olv118qdj5nqie5ebjvr.png',
            ],
            3 => [
                'id' => '24hexby4e6ap',
                'name' => 'Letter Heads',
                ...
                'image_url' => '/images/website_0wn174hkidxdvaikltdg.png',
            ],
            4 => [
                'id' => '25hexby4e6ap',
                'name' => 'Leaves',
                ...
                'image_url' => '/images/website_u4comcrtlotpnz36usue.png',
            ],
            5 => [
                'id' => '26hexby4e6ap',
                ...
                'image_url' => '/images/website_rgo3uma8fe7pwiil4kgn.png',
            ],
            6 => [
                'id' => '27hexby4e6ap',
                ...
                'image_url' => '/images/website_ir3byphfcg6u0yq9yotm.png',
            ],
            7 => [
                'id' => '28hexby4e6ap',
                'name' => 'Survey Forms',
                ...
                'image_url' => '/images/website_mnqzrinp6rt57av5hvt9.png',
            ],
        ];
        $websiteSetting->save();
            ...
            [
                ...
                "features" => [
                    [
                        ...
                        "image_url" => "/images/website_gpnhku83qhdbyksbg1do.png"
                    ],
                    [
                        "id" => "omlc24r338",
                        ...
                        "image_url" => "/images/website_orrnvnogsxmcyqupk8lj.png"
                    ],
                    [
                        "id" => "musykhbq37",
                        ...
                        "image_url" => "/images/website_zm2szogganffl4ijcyju.png"
                    ]
                ]
            ],
            [
                ...
                "features" => [
                    [
                        ...
                        "image_url" => "/images/website_lmrqpteruymqnun4fegf.png"
                    ],
                    [
                        "id" => "8y1suzijyb",
                        "title" => "Salary Slips",
                        ...
                        "image_url" => "/images/website_zqv5j9obnsw66zut67qr.jpeg"
                    ],
                    [
                        "id" => "bsfitmrezvu",
                        ...
                        "image_url" => "/images/website_5d2q57fkyxxuibmsdwlb.png"
                    ]
                ]
            ],
            [
                ...
                "features" => [
                    [
                        ...
                        "image_url" => "/images/website_7pqgalhdbqpwhgwy7wyp.png"
                    ],
                    [
                        "id" => "gkmyw3ppqxv",
                        "title" => "Offboarding",
                        ...
                        "image_url" => "/images/website_w4nzjnbzgdagx9v9yekd.png"
                    ],
                    [
                        "id" => "91hq9yjf38",
                        "title" => "Survey Forms",
                        ...
                        "image_url" => "/images/website_zh3vzylsdy1bfvcmlrvf.png"
                    ]
                ]
            ]
        ];
        ...
        $websiteSetting->credentials = array(
            ...
            array(
                ...
                'image_url' => '/images/website_umglm6u0pifn4djq1z0e.png',
            ...
            array(
                ...
                'image_url' => '/images/website_yclshvui5dn2wmq2lidu.png',
            ...
            array(
                ...
                'image_url' => '/images/website_zt0jcb4tkeqxaklrqob4.png',
        ...
        $websiteSetting->credentials = [
            [
                ...
                "image_url" => "/images/website_jf2zwtcth14fax9311xs.webp",
                "features" => [
            ...
            [
                ...
                "image_url" => "/images/website_3cvk2plqmamqrrliecks.webp",
                "features" => [
            ...
            [
                ...
                "image_url" => "/images/website_ank5yugyex2ho6n0iszp.webp",
                "features" => [
        ...
        $websiteSetting->credentials =   [
            [
                ...
                "logo_url" => "/images/website_ttzvq9lyq8tap2jdegxk.svg"
            ],
            [
                "id" => "bhxt4mzpgsq",
                "name" => "amex",
                "logo" => "website_rp6wzsipglwbxhknxowa.svg",
                "logo_url" => "/images/website_rp6wzsipglwbxhknxowa.svg"
            ],
            [
                "id" => "ugxjxtffre",
                "name" => "Visa",
                "logo" => "website_wvha7xmqfzhupfvpsehf.svg",
                "logo_url" => "/images/website_wvha7xmqfzhupfvpsehf.svg"
            ],
            [
                "id" => "aogu39r25jr",
                "name" => "Stripe",
                "logo" => "website_6abnaiqxcthjuvszymee.svg",
                "logo_url" => "/images/website_6abnaiqxcthjuvszymee.svg"
            ],
            [
                "id" => "hojcguj4k9j",
                "name" => "MasterCard",
                "logo" => "website_pvj3daufuhay4fuo4bkl.svg",
                "logo_url" => "/images/website_pvj3daufuhay4fuo4bkl.svg"
            ]
        ];
        ...
        $websiteSetting->credentials = [
            [
                ...
                'seo_image_url' => '/images/website_y39lsrsjxngtxaimfzxw.png',
            ],
            [
                'id' => '2jzmhcpnshn',
                'page_key' => 'register',
