<template>
    ...
    >
        <div v-if="menuCollapsed" class="logo" :style="{ display: 'flex', justifyContent: 'center', padding: '12px 0' }">
            <div :style="{ background: '#ffffff', borderRadius: '8px', padding: '4px', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 2px 8px rgba(0,0,0,0.15)', width: '40px', height: '40px' }">
                <img
                    :style="{
                        height: '100%',
                        width: '100%',
        ...
        <div v-else :style="{ display: 'flex', alignItems: 'center', padding: '15px 20px 10px 20px', justifyContent: 'space-between' }">
            <div :style="{ background: '#ffffff', borderRadius: '8px', padding: '6px 12px', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 4px 12px rgba(0,0,0,0.15)', height: '42px', flexGrow: 1, marginRight: innerWidth <= 991 ? '10px' : '0px' }">
                <img
                    :style="{
                        height: '100%',
                        width: '100%',
