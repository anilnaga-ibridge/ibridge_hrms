<template>
    <div v-if="permsArray.includes('locations_delete') || permsArray.includes('admin')">
    ...
    setup(props, { emit }) {
        ...
        const showDeleteConfirm = () => {
            Modal.confirm({
                ...
                content: t("location.delete_message"),
                centered: true,
                okText: t("common.yes"),
                okType: "danger",
                ...
                onOk() {
                    return axiosAdmin
                        .delete(`locations/${props.id}`)
                        .then((successResponse) => {
                            notification.success({
                                message: t("common.success"),
                                description: t("location.deleted"),
