                        ...
                        <a-col :xs="24" :sm="24" :md="12" :lg="12">
                            ...
                            >
                                <span style="display: flex">
                                    ...
                                    />
                                    <LocationEditButton
                                        v-if="formData.location_id"
                                        :id="formData.location_id"
                                        :locations="locations"
                                        @onEditSuccess="locationUpdated"
                                    />
                                    <LocationDeleteButton
                                        v-if="formData.location_id"
                                        :id="formData.location_id"
                                        @onDeleteSuccess="locationDeleted"
                                    />
                                </span>
                            </a-form-item>
                        </a-col>
                        <a-col :xs="24" :sm="24" :md="12" :lg="12">
                            ...
                            >
                                <span style="display: flex">
                                    ...
                                    />
                                    <ShiftEditButton
                                        v-if="formData.shift_id"
                                        :id="formData.shift_id"
                                        @onEditSuccess="shiftUpdated"
                                    />
                                    <ShiftDeleteButton
                                        v-if="formData.shift_id"
                                        :id="formData.shift_id"
                                        @onDeleteSuccess="shiftDeleted"
                                    />
                                </span>
                            </a-form-item>
                        </a-col>
                            ...
                            >
                                <span style="display: flex">
                                    ...
                                    <DepartmentEditButton
                                        v-if="formData.department_id"
                                        :id="formData.department_id"
                                        :departments="departments"
                                        @onEditSuccess="departmentUpdated"
                                    />
                                    <DepartmentDeleteButton
                                        v-if="formData.department_id"
                                        :id="formData.department_id"
                                        @onDeleteSuccess="departmentDeleted"
                                    />
                                </span>
                            </a-form-item>
                        </a-col>
                            ...
                            >
                                <span style="display: flex">
                                    ...
                                    <DesignationEditButton
                                        v-if="formData.designation_id"
                                        :id="formData.designation_id"
                                        :designations="designations"
                                        @onEditSuccess="designationUpdated"
                                    />
                                    <DesignationDeleteButton
                                        v-if="formData.designation_id"
                                        :id="formData.designation_id"
                                        @onDeleteSuccess="designationDeleted"
                                    />
                                </span>
                            </a-form-item>
                        </a-col>
...
import DepartmentEditButton from "../departments/EditButton.vue";
import DepartmentDeleteButton from "../departments/DeleteButton.vue";
import DesignationAddButton from "../designations/AddButton.vue";
import DesignationEditButton from "../designations/EditButton.vue";
import DesignationDeleteButton from "../designations/DeleteButton.vue";
import ShiftAddButton from "../shifts/AddButton.vue";
import ShiftEditButton from "../shifts/EditButton.vue";
import ShiftDeleteButton from "../shifts/DeleteButton.vue";
import LocationAddButton from "../../settings/location/AddButton.vue";
import LocationEditButton from "../../settings/location/EditButton.vue";
import LocationDeleteButton from "../../settings/location/DeleteButton.vue";
...
export default defineComponent({
    ...
    setup(props, { emit }) {
        ...
        const departmentUpdated = (xid) => {
            axiosAdmin.get(departmentUrl).then((response) => {
                departments.value = response.data;
            });
        };

        const departmentDeleted = (xid) => {
            axiosAdmin.get(departmentUrl).then((response) => {
                departments.value = response.data;
                if (props.formData.department_id === xid) {
                    props.formData.department_id = undefined;
                }
            });
        };
        ...
        const designationUpdated = (xid) => {
            axiosAdmin.get(designationUrl).then((response) => {
                designations.value = response.data;
            });
        };

        const designationDeleted = (xid) => {
            axiosAdmin.get(designationUrl).then((response) => {
                designations.value = response.data;
                if (props.formData.designation_id === xid) {
                    props.formData.designation_id = undefined;
                }
            });
        };
        ...
        const shiftUpdated = (xid) => {
            axiosAdmin.get(shiftUrl).then((response) => {
                shifts.value = response.data;
            });
        };

        const shiftDeleted = (xid) => {
            axiosAdmin.get(shiftUrl).then((response) => {
                shifts.value = response.data;
                if (props.formData.shift_id === xid) {
                    props.formData.shift_id = undefined;
                }
            });
        };
        ...
        const locationUpdated = (xid) => {
            axiosAdmin.get(locationUrl).then((response) => {
                locations.value = response.data;
            });
        };

        const locationDeleted = (xid) => {
            axiosAdmin.get(locationUrl).then((response) => {
                locations.value = response.data;
                if (props.formData.location_id === xid) {
                    props.formData.location_id = undefined;
                }
            });
        };
