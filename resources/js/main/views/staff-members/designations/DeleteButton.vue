<template>
    <div v-if="permsArray.includes('designations_delete') || permsArray.includes('admin')">
    ...
    setup(props, { emit }) {
        ...
        const showDeleteConfirm = () => {
            Modal.confirm({
                ...
                content: t("designation.delete_message"),
                centered: true,
                okText: t("common.yes"),
                okType: "danger",
                ...
                onOk() {
                    return axiosAdmin
                        .delete(`designations/${props.id}`)
                        .then((successResponse) => {
                            notification.success({
                                message: t("common.success"),
                                description: t("designation.deleted"),
