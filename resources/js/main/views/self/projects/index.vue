...
import fields from "../../projects/fields";
...
export default {
    ...
    setup() {
        ...
        const updateStats = () => {
            if (datatableVariables.table.data) {
        ...
        watch(() => datatableVariables.table.data, () => {
            updateStats();
        }, { deep: true });

        onMounted(() => {
            datatableVariables.tableUrl.value = {
                url: "self/projects?fields=id,xid,name,status,start_date,deadline,description,members,member_details,customer,calculate_progress,progress,billing_type,total_rate,estimated_hours,tags,send_email&limit=1000",
            };
