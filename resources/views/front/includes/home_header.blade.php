<div class="flex flex-wrap justify-between -m-6 pt-26 pb-10">
    <div class="w-full lg:w-5/12 xl:w-1/2 p-6">
        <p class="mb-3 font-heading text-gray-600 font-medium text-lg">
            {{ $frontSetting->header_sub_title }}
        </p>
        <h1 class="mb-5 font-heading text-2xl md:text-4xl xl:text-6xl text-gray-900 font-bold">
        ...
        <ul class="mb-10">
            @foreach ($frontSetting->header_features as $currentHeaderFeature)
                <li class="mb-4 flex items-center font-heading font-semibold text-base text-gray-800">
        ...
        <div class="flex flex-wrap -m-3 mb-10">
            ...
            <div class="w-full lg:w-auto p-3">
                <a href="{{ $frontSetting->header_button2_url }}" class="font-heading w-full block text-center px-6 py-3 text-base text-gray-900 bg-transparent border border-gray-500 hover:border-gray-900 rounded-md">
        ...
        <div class="lg:max-w-md">
            <div class="flex flex-wrap -m-3">
                ...
                <div class="flex-1 p-3">
                    <p class="mb-4 text-gray-600 text-base">
                        {{ $frontSetting->header_client_text }}
                    </p>
                    <p class="font-heading text-gray-900 text-base">
